...
*The Rev A order record. Written 2026-08-17 as the pre-order decision sheet and completed 2026-08-21 when the order was placed. §7 records what was actually ordered; the ordered gerber zip, BOM and CPL are frozen alongside this file.*
...
**Order placed 2026-08-21.** 5 boards, fab + Standard PCBA, paid ≈ **$49.26 after coupons** (PCB $12.10 + PCBA $86.79 − ~$49.63 coupons) + **$28.67 DHL Express (DDP — duties prepaid, nothing billed later)**.
